...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/saltzmanjoelh/swift-aws-lambda-runtime", .upToNextMajor(from: "0.5.2")),
        .package(url: "https://github.com/saltzmanjoelh/swift-aws-lambda-events", .upToNextMajor(from: "0.0.1")),
