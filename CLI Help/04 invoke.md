...
USAGE: aws-deploy invoke <function> [--payload <payload>] [--endpoint-url <endpoint-url>]

ARGUMENTS:
  <function>              The name of the Lambda function, version, or alias. 
                          Name formats     Function name - my-function
                          (name-only), my-function:v1 (with alias).
                          Function ARN -
...
OPTIONS:
  -l, --payload <payload> If you don't provide a payload, an empty string will
